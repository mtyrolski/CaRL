...
class SecondLayerSolver(Solver):
    def is_solved(self):
        ...
        success = (self.cube.cubies['FL'].facings['F'] == front_color
                   and self.cube.cubies['FL'].facings['L'] == left_color)
        success = (success and self.cube.cubies['FR'].facings['F'] == front_color
                   and self.cube.cubies['FR'].facings['R'] == right_color)
        success = (success and self.cube.cubies['BL'].facings['B'] == back_color
                   and self.cube.cubies['BL'].facings['L'] == left_color)
        return (success and self.cube.cubies['BR'].facings['B'] == back_color
                and self.cube.cubies['BR'].facings['R'] == right_color)
