...
class Move:
    ...
    def __add__(self, move):
        if isinstance(move, str | basestring):
            ...
            offset = ((self.clockwise + (self.double * 2) + (self.counterclockwise * 3)) +
                      (move.clockwise + (move.double * 2) + (move.counterclockwise * 3))) % 4
            ...
            raise ValueError(f'Unable to add {self.raw} and {str(move)}')
